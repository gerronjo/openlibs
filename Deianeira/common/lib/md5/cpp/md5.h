...
#ifdef MD5_API
#else
#define MD5_API _declspec(dllimport)
#endif
///
...
MD5_API char* PrintMD5(uchar md5Digest[16]);  ///增加MD5_API
MD5_API char* MD5String(char* szString);      ///增加MD5_API
MD5_API char* MD5File(char* szFilename);      ///增加MD5_API

class MD5_API md5                             ///增加MD5_API
{
// Methods
public:
	md5() { Init(); }
