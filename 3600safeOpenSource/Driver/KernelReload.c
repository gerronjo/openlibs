...
// BOOL FixBaseRelocTable(BYTE *ImageBase,DWORD ExistImageBase)
// {
// 	PIMAGE_BASE_RELOCATION ImageBaseReloc=NULL;
// 	PIMAGE_BASE_RELOCATION RelocationDir;
// 	PIMAGE_BASE_RELOCATION RelocationEnd;
// 	DWORD RelocSize;
// 	int ItemCount,Index;
// 	int Type;
// 	PDWORD RelocAddress;
...
// 	OriginalImageBase=ImageNtHeaders->OptionalHeader.ImageBase;
// 
...
// 	{
// 		//	KdPrint(("get reloc failed\n"));  
// 		return FALSE;  
// 	}
// 	RelocationDDir =&ImageNtHeaders->OptionalHeader.DataDirectory[IMAGE_DIRECTORY_ENTRY_BASERELOC];
// 
// 	RelocationDir = (PIMAGE_BASE_RELOCATION)((ULONG_PTR)ImageBase + RelocationDDir->VirtualAddress);
// 	RelocationEnd = (PIMAGE_BASE_RELOCATION)((ULONG_PTR)ImageBase + RelocationDDir->VirtualAddress + RelocationDDir->Size);
// 
// 	while (RelocationDir < RelocationEnd && ImageBaseReloc->SizeOfBlock > 0)
// 	{  
// 		ItemCount=(ImageBaseReloc->SizeOfBlock-8)/2;
// 
// 		for (Index=0;Index<ItemCount;Index++)
// 		{
// 			if (MmIsAddressValid(((DWORD)ImageBaseReloc + sizeof(IMAGE_BASE_RELOCATION))))
// 			{
...
// 				{
// 					RelocAddress = (PDWORD)((DWORD)(TypeOffset[Index]&0x0fff) + ImageBaseReloc->VirtualAddress+ImageBase);
// 					//KdPrint(("%X\n",RelocAddress));
// 					*RelocAddress=*RelocAddress+(ExistImageBase-OriginalImageBase);
// 				}
// 			}
// 		}
