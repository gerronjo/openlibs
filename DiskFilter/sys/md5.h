...
extern "C" {
	...
	void MD5Update(register MD5_CTX *mdContext, unsigned char *bug, unsigned int len);
	void MD5Final(unsigned char digest[16], MD5_CTX *mdContext);
	void MD5Transform(register UINT4 *buf, register UINT4 *in);
	
	extern void CalcMD5( const void *data, unsigned int len, void *dest );
