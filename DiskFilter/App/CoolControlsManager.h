...
class CCoolControlsManager {
   ...
   public:
	  ...
	  static std::map<void *, void *>	m_ctrlMap;
	  static std::map<WORD, void *>	m_threadMap;
   ...
   protected:
      ...
      static std::map<void *, void *> m_dlgMap;         // Map for dialog window (in general - for owner of controls)
